...
if (length(args) < 4) {
  stop("Rscript 10Fold_CrossValidation.r <data file> <output PDF> <organism name> <cutoff file>")
}

# Assign command-line arguments to variables
data_file <- args[1]      # Input data file
output_pdf <- args[2]  
...
write.table(output,file="test1.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test2.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test3.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test4.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test5.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test6.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test7.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test8.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test9.xls",quote=F,sep="\t",row.names=F)
...
test$prob <- predict(mylogit,newdata=test,type="response")
output = cbind("mRNA"=test$vmrna, "ORF"=test$vorf, "Fickett"=test$vfickett, "Hexamer" = test$vhexamer, "Label"=test$vlabel,"Prob"=test$prob)
write.table(output,file="test10.xls",quote=F,sep="\t",row.names=F)
...
Response = list(as.numeric(test1$Prob), as.numeric(test2$Prob), as.numeric(test3$Prob), as.numeric(test4$Prob), as.numeric(test5$Prob), as.numeric(test6$Prob), as.numeric(test7$Prob), as.numeric(test8$Prob), as.numeric(test9$Prob), as.numeric(test10$Prob))
Labls = list( as.numeric(test1$Label), as.numeric(test2$Label), as.numeric(test3$Label), as.numeric(test4$Label), as.numeric(test5$Label), as.numeric(test6$Label), as.numeric(test7$Label), as.numeric(test8$Label), as.numeric(test9$Label), as.numeric(test10$Label))
...
mtext(organism_name, side=3, line=0.5, cex=1, font=2)
...
intersection_point <- which.min(abs(S@y.values[[1]] - P@y.values[[1]]))
cutoff_intersection <- S@x.values[[1]][intersection_point]
sensitivity_at_intersection <- S@y.values[[1]][intersection_point]
specificity_at_intersection <- P@y.values[[1]][intersection_point]
abline(h=sensitivity_at_intersection,lty="dashed",lwd=0.5)
abline(v=cutoff_intersection,lty="dashed",lwd=0.5)
legend(0.4,0.85,col=c("blue","red"),lwd=2,legend=c("Sensitivity","Specificity"))
mtext(paste("CPC=", round(cutoff_intersection, 3)), 
      side = 1, line = 2, at = cutoff_intersection, col = 'red', cex = 0.75)
